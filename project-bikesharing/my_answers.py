...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        delta_weights_i_h += np.matmul(X[:,None], hidden_error_term[None,:])
        # Weight step (hidden to output)
        delta_weights_h_o += np.matmul(hidden_outputs[:,None], output_error_term[None,:])
...
# Training loss: 0.055 ... Validation loss: 0.132
# iterations = 10000
# learning_rate = .3
# hidden_nodes = 50

# Training loss: 0.076 ... Validation loss: 0.168
# Training loss: 0.070 ... Validation loss: 0.154
# iterations = 5000
# learning_rate = .3
# hidden_nodes = 50
